...
if(tomarAsistencia)return <TomarAsistencia curso={curso} registros={registros} onGuardar={()=>{setTomarAsistencia(false);cargarCurso();}} onVolver={()=>setTomarAsistencia(false)}/>;
return(
...
<button key={t} style={{padding:'8px 20px',fontSize:14,cursor:'pointer',border:'none',background:'none',col